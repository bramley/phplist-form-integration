	...
	function phplist_widget($args) {
		...
		if(phplist_check_input()) // If the input check returns true (ie. there has been a subscriber & input is ok)
		{
			   if(phplist_subscribe($_POST, true) === true) {
			   		...
			   		echo("<p>We were unable to add your email to our list. Please send us an email at <a href=\"mailto:support@getoutbayarea.com\">support@getoutbayarea.com</a> letting us know what happened and we'll make sure you get on the list.");
			   }
		}
